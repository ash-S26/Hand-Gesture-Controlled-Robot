...
while(True):
    ...
    lower_bound_color = np.array([0,58,30],np.uint8)         #range for creating mask to seperate skin colour from video frame
    upper_bound_color = np.array([33,255,255],np.uint8)
   ...
   #Finding contors of eroded mask image
    ...
    for cnt in contours:
        ...
        if area > 2000:                      # eliminating small contors 
    ...
    while action == 0 :
        ...
        velocity_message.linear.x= forward
    ...
    time.sleep(0.033)
    cv2.putText(frame,"0 - move Forward",(0,20),cv2.FONT_HERSHEY_SIMPLEX,0.5,(0,255,0),2,cv2.LINE_AA)
    cv2.putText(frame,"1 - move Backward",(0,40),cv2.FONT_HERSHEY_SIMPLEX,0.5,(0,255,0),2,cv2.LINE_AA)
    cv2.putText(frame,"2 - STOP",(0,60),cv2.FONT_HERSHEY_SIMPLEX,0.5,(0,255,0),2,cv2.LINE_AA)
    cv2.putText(frame,"3 - move_Right",(0,80),cv2.FONT_HERSHEY_SIMPLEX,0.5,(0,255,0),2,cv2.LINE_AA)
    cv2.putText(frame,"4 - Restore_Orignal_Velocity(0.2)",(0,100),cv2.FONT_HERSHEY_SIMPLEX,0.5,(0,255,0),2,cv2.LINE_AA)
    cv2.putText(frame,"5 - move_Left",(0,120),cv2.FONT_HERSHEY_SIMPLEX,0.5,(0,255,0),2,cv2.LINE_AA)
    cv2.putText(frame,"6 - Accelarate-current_v-{}".format(forward),(0,140),cv2.FONT_HERSHEY_SIMPLEX,0.5,(0,255,0),2,cv2.LINE_AA)
    cv2.imshow("frame",frame)
